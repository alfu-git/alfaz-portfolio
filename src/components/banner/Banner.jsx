...
const Banner = () => {
  return (
    <section id="home" className="mt-5 mb-10 max-w-7xl w-full mx-auto px-5">
      <div className="flex flex-col-reverse gap-y-15 lg:flex-row lg:justify-between lg:items-center">
        ...
        <div>
          <figure className="max-w-60 max-h-60 mx-auto sm:max-w-100 sm:max-h-100 p-2 glass-1 rounded-full flex items-center justify-center overflow-hidden">
            <Image
